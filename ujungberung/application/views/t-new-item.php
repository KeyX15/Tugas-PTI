                ...
                <tbody>
                    ...
                    <?php foreach ($daftar_item as $item) { ?>
                        <tr>
                            ...
                            <td width="50">
                                <a href="<?php echo site_url('newitem/delete_item/'.$item->kd_model); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin untuk menghapus produk ini?');">
